...
export default function ProjectItem({
  ...
  return (
    <div className="relative flex flex-col items-center my-6 py-2 text-center border-t-4 border-b border-blue-700">
      ...
      <span className="absolute top-3 left-2 px-2 bg-green-400 text-white rounded">
        Project: {' ' + project}
      </span>
      <div className=" text-left  w-full rounded px-1">
        ...
        <p className=" font-thin text-sm ">{algorithms}</p>
        <a className="text-blue-300 hover:text-blue-700 font-semibold text-sm">
          Read more about
        </a>
      </div>
    </div>
